...
Requirements:
อธิบาย Root Cause ของช่องโหว่นี้แบบกระชับ (Technical Breakdown)
บอกวิธี Remediation หรือการ Patch ในโปรเจกต์ NestJS

Provide Unit Test: ขอตัวอย่างโค้ดโดยใช้ Jest เพื่อจำลอง Attack Vector และพิสูจน์ว่า Patch แล้ว (Fix Verification)
```